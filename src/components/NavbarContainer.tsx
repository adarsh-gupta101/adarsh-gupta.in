      ...
      <MenuItem setActive={setActive} active={active} item="Home"> </MenuItem>
        ...
        <MenuItem setActive={setActive} active={active} item="Connect">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink href="https://twitter.com/adarsh____gupta">Twitter</HoveredLink>
            <HoveredLink href="https://www.youtube.com/@Adarsh_guptaa">Youtube</HoveredLink>
            <HoveredLink href="https://github.com/adarsh-gupta101">Github</HoveredLink>
